# Generated by Powerlevel10k configuration wizard on 2026-01-08 at 20:58 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER='#82aaff'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{#f7768e}'   # red foreground
      local   modified='%F{#9ece6a}'  # green foreground
